...
--
-- Host: localhost
-- Generation Time: Mar 25, 2016 at 06:26 PM
...
CREATE TABLE IF NOT EXISTS `destination` (
  ...
  `destination-groupb` varchar(255) NOT NULL DEFAULT '0',
  `destination-groupa` varchar(255) NOT NULL DEFAULT '0',
  `destination-controller1` varchar(255) NOT NULL DEFAULT '0',
  `destination-server1` varchar(255) NOT NULL DEFAULT '0',
  `destination-client1` varchar(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `source` (
  ...
  `source-groupb` varchar(255) NOT NULL DEFAULT '0',
  `source-groupa` varchar(255) NOT NULL DEFAULT '0',
  `source-controller1` varchar(255) NOT NULL DEFAULT '0',
  `source-server1` varchar(255) NOT NULL DEFAULT '0',
  `source-client1` varchar(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;
